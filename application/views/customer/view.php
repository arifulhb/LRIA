...
<?php
if($_record[0]['mrcnt_status']=='active'){ ?>
<li class="pull-right"><a href="<?php echo base_url().'merchant/daily-report/'.$_record[0]['mrcnt_sn'];?>"
        class="btn btn-xs btn-default"><i class="fa fa-upload"></i> Manual Post</a></li>
<?php }//end if ?>
</ul>
...
<section class="panel panel-primary">
    <header class="panel-heading clearfix">
        ...
        <a class="btn btn-primary pull-right" href="<?php echo base_url().'customer/edit/'.$_sn;?>"
           style="padding: 0 10px;"
           role="button"><i class="fa fa-pencil"></i> Edit this Customer</a>
    </header>
    ...
    <div class="panel-body">
        ...
        if($_mrcnt_xero_api_key !=''  && $_mrcnt_xero_api_secret !=''){
            ...
            if(count($_linked_accounts)<=0){ ?>
                ...
                <div role="alert" class="alert alert-danger fade in">
                    <button data-dismiss="alert" class="close" type="button"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                    <h4>Oh snap! Lightspeed and XERO Accounts are not Linked!</h4>
        ...
        /* Lightspeed Company ID */

        if($_mrcnt_pos_company_id =='' || $_mrcnt_pos_company_id == null){ ?>

            <div role="alert" class="alert alert-danger fade in">
                <button data-dismiss="alert" class="close" type="button"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                <h4>Oh snap! Lightspeed Company ID!</h4>
                <p><strong>Lightspeed Company ID</strong>  is not updated. Please
                    <a class="btn btn-danger btn-sm" type="button" title="Config"
                       href="<?php echo base_url().'customer/edit/'.$_sn; ?>"><i class="fa fa-pencil"></i> Update</a></p>
            </div>
...
<div class="row">
    ...
    <div class="col-lg-6">
        <section class="panel panel-info">
            <div class="panel-heading">Lightspeed</div>
            <div class="panel-body">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="" class="col-lg-6 col-sm-6 control-label">Lightspeed Company ID</label>
                                <div class="col-lg-6">
...
<section id="mrcnt_transactions" class="panel panel-default">
    <div class="panel-heading"><strong>Recent Transactions</strong>
        <a class="btn btn-link pull-right" href="<?php echo base_url().'merchant/view/'.$_sn.'/all-transactions';?>" 
                    ...
                    <tr id="tran_row_<?php echo $tran['tran_sn'];?>">
                        ...
                        <td><?php 
                            if($tran['tran_status']!='success'){
                                echo '<span class="label label-danger">'.$tran['tran_status'].'</span>';
                            }
                            else{
...
<section class="panel panel-default">
    <div class="panel-heading"><strong>Accounts</strong>
        ...
        if($_mrcnt_xero_api_key != '' && $_mrcnt_xero_api_secret !=''){ ?>
            <a class="btn btn-default btn-sm pull-right" href="<?php echo base_url().'merchant/account-config/'.$_sn.'/?accounts=1';?>"
